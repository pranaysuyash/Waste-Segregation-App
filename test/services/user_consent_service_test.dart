  ...
  group('UserConsentService Tests', () {
    ...
    group('GDPR Compliance', () {
      test('should initialize with no consent by default', () {
        when(() => mockSharedPreferences.getBool(any<String>()))
            .thenReturn(null);
      ...
      test('should set and get analytics consent', () async {
        when(() => mockSharedPreferences.setBool(any<String>(), any<bool>()))
        ...
        verify(() => mockSharedPreferences.setBool('analytics_consent', true))
            .called(1);
      });
      ...
      test('should set and get marketing consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool('marketing_consent', true))
            .called(1);
      });
      ...
      test('should set and get functional consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool('functional_consent', true))
            .called(1);
      });
      ...
      test('should set and get data processing consent', () async {
        ...
        verify(() =>
                mockSharedPreferences.setBool('data_processing_consent', true))
            .called(1);
      });
    });
    ...
    group('Consent Management', () {
      ...
      test('should revoke all consents', () async {
        ...
        verify(() => mockSharedPreferences.setBool('analytics_consent', false))
            .called(1);
        verify(() => mockSharedPreferences.setBool('marketing_consent', false))
            .called(1);
        verify(() => mockSharedPreferences.setBool('functional_consent', false))
            .called(1);
        verify(() =>
                mockSharedPreferences.setBool('data_processing_consent', false))
            .called(1);
      });
      ...
      test('should set consent timestamp', () async {
        ...
        verify(() => mockSharedPreferences.setString(
            'consent_timestamp', timestamp.toIso8601String())).called(1);
      });
    ...
    group('Data Subject Rights', () {
      ...
      test('should record data deletion request', () async {
        ...
        verify(() => mockSharedPreferences.setString(
            ...
            requestTime.toIso8601String())).called(1);
      });
      ...
      test('should record data export request', () async {
        ...
        verify(() => mockSharedPreferences.setString(
                'data_export_request_timestamp', requestTime.toIso8601String()))
            .called(1);
      });
      ...
      test('should get data deletion request timestamp', () {
        ...
        when(() => mockSharedPreferences
                .getString('data_deletion_request_timestamp'))
            .thenReturn(timestamp.toIso8601String());

        final retrievedTimestamp =
            userConsentService.dataDeletionRequestTimestamp;
      ...
      test('should get data export request timestamp', () {
        final timestamp = DateTime(2024, 1, 15, 10, 30);
        when(() => mockSharedPreferences
                .getString('data_export_request_timestamp'))
            .thenReturn(timestamp.toIso8601String());

        final retrievedTimestamp =
            userConsentService.dataExportRequestTimestamp;
    ...
    group('Cookie Consent', () {
      test('should manage essential cookies consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool(
            'essential_cookies_consent', true)).called(1);
      });
      ...
      test('should manage performance cookies consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool(
            'performance_cookies_consent', true)).called(1);
      });
      ...
      test('should manage advertising cookies consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool(
            'advertising_cookies_consent', true)).called(1);
      });
    });
    ...
    group('Third-Party Services', () {
      test('should manage Google Analytics consent', () async {
        ...
        verify(() =>
                mockSharedPreferences.setBool('google_analytics_consent', true))
            .called(1);
      });
      ...
      test('should manage Firebase consent', () async {
        ...
        verify(() => mockSharedPreferences.setBool('firebase_consent', true))
            .called(1);
      });
      ...
      test('should manage crash reporting consent', () async {
        ...
        verify(() =>
                mockSharedPreferences.setBool('crash_reporting_consent', true))
            .called(1);
      });
    });
    ...
    group('Consent Banner Management', () {
      ...
      test('should dismiss consent banner', () async {
        ...
        verify(() =>
                mockSharedPreferences.setBool('consent_banner_dismissed', true))
            .called(1);
      });
    ...
    group('Consent Audit Trail', () {
      ...
      test('should limit audit trail size', () async {
        ...
        final largeAuditTrail = List.generate(
            200,
            (index) =>
    ...
    group('Regional Compliance', () {
      test('should set user region for compliance', () async {
        ...
        verify(() => mockSharedPreferences.setString('user_region', 'EU'))
            .called(1);
      });
    ...
    group('Performance Tests', () {
      test('should handle multiple rapid consent changes efficiently',
          () async {
        when(() => mockSharedPreferences.setBool(any<String>(), any<bool>()))
            .thenAnswer((_) async => true);
        ...
        verify(() =>
                mockSharedPreferences.setBool('analytics_consent', any<bool>()))
            .called(100);
      });

      test('should handle large audit trail efficiently', () {
        final largeAuditTrail = List.generate(
            1000, (index) => '2024-01-01T10:30:00.000|analytics_consent|true');
