  ...
  group('AiService', () {
    ...
    group('Image Classification', () {
      test('should return valid classification for valid image path', () async {
        ...
        expect(() async => await aiService.classifyWasteImage('invalid_path.jpg'), 
               throwsA(isA<Exception>()));
      });

      test('should handle null or empty image path', () async {
        expect(() async => await aiService.classifyWasteImage(''), 
               throwsA(isA<Exception>()));
      });
    });
    ...
    group('Error Handling', () {
      test('should handle network errors gracefully', () async {
        ...
        expect(() async => await aiService.classifyWasteImage('non_existent_file.jpg'),
               throwsA(isA<Exception>()));
      });

      test('should handle invalid file formats', () async {
        // Test invalid file format
        expect(() async => await aiService.classifyWasteImage('invalid_file.txt'),
               throwsA(isA<Exception>()));
      });
    });
