...
class ApiConfig {
  ...
  static const String tertiaryModel = String.fromEnvironment('GEMINI_API_MODEL',
...
class AppTheme {
  ...
  static ThemeData get highContrastDarkTheme => fromScheme(ColorScheme.fromSeed(
      seedColor: seedColor, brightness: Brightness.dark, contrastLevel: 1.0));
  ...
  static const Color rewardGold = Color(0xFFFFD23F); // Achievements & rewards
  static const Color manualReviewColor =
      Color(0xFF795548); // Brown for manual review
  ...
  static const double buttonHeightSm =
      48.0; // FIXED: Was 36.0, now meets 48dp minimum
  ...
  static const Color secondaryColor = dryWasteColor;
  static const Color accentColor = rewardGold;
  static const Color textPrimaryColor = Color(0xFF212121);
  static const Color textSecondaryColor = Color(0xFF757575);
  static const Color textDisabledColor = Color(0xFF9E9E9E);
  static const Color backgroundColor = Color(0xFFFFFFFF);
  static const Color surfaceColor = Color(0xFFFFFFFF);
  static const Color errorColor = hazardousWasteColor;

  // Additional semantic colors
  static const Color successColor = wetWasteColor;
  static const Color warningColor = rewardGold;
  static const Color infoColor = dryWasteColor;
  static const Color neutralColor = Color(0xFF9E9E9E);

  // Dark theme individual color constants
  static const Color darkPrimaryColor = seedColor;
  static const Color darkSecondaryColor = dryWasteColor;
  static const Color darkAccentColor = rewardGold;
  ...
  static const Color darkErrorColor = hazardousWasteColor;
  ...
  static ButtonStyle dialogCancelButtonStyle(BuildContext context) {
    ...
    return TextButton.styleFrom(
      foregroundColor: isDarkMode
          ...
          : Colors.grey.shade700, // Explicit neutral colors
...
class AppStrings {
  ...
  static const String takeFirstPhoto =
...
class AppIcons {
  ...
  static const IconData workspacePremium =
  ...
  static const IconData emojiEvents =
      IconData(0xea65, fontFamily: 'MaterialIcons');
  ...
  static const IconData medicalServices =
      IconData(0xe95a, fontFamily: 'MaterialIcons');
  ...
  static const IconData autoAwesome =
...
class WasteInfo {
  static const Map<String, String> categoryExamples = {
    'Wet Waste':
        'Food scraps, fruit peels, vegetable waste, garden trimmings, tea bags, coffee grounds',
    'Dry Waste':
        'Paper, cardboard, plastic bottles, glass bottles, metal cans, tetra packs',
    'Hazardous Waste':
        'Batteries, electronic items, lightbulbs, paint cans, aerosol cans, chemicals',
    'Medical Waste':
        'Medicine, bandages, syringes, expired medicines, blood-soaked items',
    'Non-Waste':
        'Reusable items, items for donation, functional electronics, books, toys',
    'Requires Manual Review':
        'Items that could not be automatically identified by AI - please identify manually',
  };

  static const Map<String, String> disposalInstructions = {
    'Wet Waste':
        'Dispose in green bin. Can be composted to create nutrient-rich soil.',
    'Dry Waste': 'Dispose in blue bin. Can be recycled into new products.',
    'Hazardous Waste':
        'Do not mix with regular waste. Take to designated collection centers.',
    'Medical Waste':
        'Seal in special bags and dispose according to local medical waste guidelines.',
    'Non-Waste':
        'Consider donating, reusing, or repurposing instead of disposing.',
    'Requires Manual Review':
  ...
  static const Map<String, String> subcategoryExamples = {
    ...
    'Food Waste':
        'Fruit peels, vegetable scraps, leftover food, spoiled food, eggshells, bones',
    'Garden Waste':
        'Grass clippings, leaves, small branches, flowers, plant trimmings',
    'Animal Waste': 'Pet waste, manure, bedding material from pet cages',
    'Biodegradable Packaging':
        'Paper bags, compostable food containers, biodegradable plastics',
    'Other Wet Waste': 'Soiled paper towels, tissues, natural cork, sawdust',

    // Dry Waste Subcategories
    'Paper':
        'Newspapers, magazines, office paper, envelopes, books, paper bags',
    'Plastic':
        'Plastic bottles, containers, packaging, toys, utensils (with recycling codes)',
    ...
    'Electronic Waste':
        'Old computers, phones, TVs, cables, chargers, electronic devices',
    'Batteries':
        'Car batteries, household batteries, lithium-ion batteries, button cells',
    'Chemical Waste':
        'Cleaning products, pesticides, herbicides, solvents, pool chemicals',
    ...
    'Automotive Waste':
        'Motor oil, antifreeze, brake fluid, filters, wiper fluid',
    ...
    'Pharmaceutical':
        'Expired medications, unused medicines, vitamins, supplements',
    'Infectious':
        'Bandages, swabs, gloves contaminated with blood or bodily fluids',
    ...
    'Repurposable Items':
        'Glass jars, paper scraps for crafts, old furniture for upcycling',
    'Other Non-Waste':
        'Materials that can be shared or reused in community programs',
  };
  ...
  static const Map<String, String> subcategoryDisposal = {
    ...
    'Garden Waste':
        'Compost or dispose in green bin. Large branches may need to be cut into smaller pieces.',
    'Animal Waste':
    ...
    'Other Wet Waste':
        'Dispose in green bin. Ensure paper products are not contaminated with chemicals.',

    // Dry Waste Subcategories
    'Paper':
        'Recycle in blue bin. Remove any plastic coatings or metal attachments when possible.',
    'Plastic':
        'Check recycling codes (1-7). Clean containers before recycling. Dispose in blue bin.',
    'Glass':
        'Rinse and recycle in blue bin. Remove lids and caps which may be recycled separately.',
    'Metal':
        'Clean and recycle in blue bin. Larger metal items may need to go to special recycling centers.',
    'Carton':
        'Rinse, flatten, and recycle in blue bin. Some areas collect cartons separately.',
    'Textile':
        'Clean textiles can be donated or recycled at textile collection points.',
    'Rubber':
        'Small rubber items may go in general waste. Check for specialized recycling programs.',
    'Wood':
        'Untreated wood can be recycled or repurposed. Treated wood requires special disposal.',
    'Other Dry Waste':
        'Check local guidelines for specific materials. Some may require special handling.',

    // Hazardous Waste Subcategories
    'Electronic Waste':
        'Take to e-waste collection centers or electronic retailer take-back programs.',
    'Batteries':
        'Never put in regular trash. Take to battery recycling drop-off points.',
    'Chemical Waste':
        'Take to hazardous waste collection events. Never pour down drains or put in regular trash.',
    'Paint Waste':
        'Take to paint recycling centers. Dried latex paint can sometimes go in regular trash.',
    'Light Bulbs':
        'CFL and fluorescent tubes contain mercury - take to special collection points.',
    'Aerosol Cans':
        'Ensure completely empty. Some areas accept in metal recycling if empty.',
    'Automotive Waste':
        'Take to auto parts stores or garages that accept used fluids and parts.',
    'Other Hazardous Waste':
        'Take to hazardous waste collection events or facilities.',

    // Medical Waste Subcategories
    'Sharps':
        'Always place in approved sharps containers and take to collection points.',
    'Pharmaceutical':
        'Take to medication take-back programs. Do not flush down toilet.',
    'Infectious':
        'Double-bag and seal. Follow local healthcare waste guidelines.',
    'Non-Infectious':
        'Some items may be recyclable if not contaminated. Otherwise dispose as general waste.',
    'Other Medical Waste':
        'Follow healthcare provider instructions or contact local health department.',

    // Non-Waste Subcategories
    'Reusable Items': 'Continue using or share with friends and family.',
    'Donatable Items':
        'Give to charity shops, shelters, or community organizations.',
    'Edible Food':
        'Share with food banks, community fridges, or through food sharing apps.',
    'Repurposable Items':
        'Use for DIY projects, crafts, or find creative reuse ideas online.',
    'Other Non-Waste':
        'Consider free cycle networks or community exchange programs.',
  };

  // Color codes for different waste types (UI palette alignment)
  static const Map<String, String> colorCoding = {
    'Wet Waste': '#06FFA5', // Vibrant Green
    'Dry Waste': '#00B4D8', // Ocean Blue
    'Hazardous Waste': '#FF6B6B', // Sunset Coral
    'Medical Waste': '#845EC2', // Digital Purple
    'Non-Waste': '#FF8AC1', // Soft Pink
