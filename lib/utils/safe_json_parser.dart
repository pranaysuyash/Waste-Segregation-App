...
class SafeJsonParser {
  ...
  static String getString(Map<String, dynamic> json, String key, {String? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid string type, got ${value.runtimeType}');
  }
  ...
  static int getInt(Map<String, dynamic> json, String key, {int? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid int type, got ${value.runtimeType}');
  }
  ...
  static double getDouble(Map<String, dynamic> json, String key, {double? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid double type, got ${value.runtimeType}');
  }
  ...
  static bool getBool(Map<String, dynamic> json, String key, {bool? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid bool type, got ${value.runtimeType}');
  }
  ...
  static DateTime getDateTime(Map<String, dynamic> json, String key, {DateTime? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid DateTime string, got ${value.runtimeType}');
  }
  ...
  static List<T> getList<T>(
    ...
    if (value is! List) {
      throw ArgumentError('Field "$key" is not a List, got ${value.runtimeType}');
    }
  ...
  static Map<String, dynamic> getMap(Map<String, dynamic> json, String key, {Map<String, dynamic>? defaultValue}) {
    ...
    throw ArgumentError('Field "$key" is not a valid Map, got ${value.runtimeType}');
  }

  /// Safely extracts an optional Map from JSON
  static Map<String, dynamic>? getOptionalMap(Map<String, dynamic> json, String key) {
    final value = json[key];
    if (value == null) return null;
    if (value is Map<String, dynamic>) return value;
    if (value is Map) {
