...
class MemoryManagementService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      WasteAppLogger.info('Memory management service initialized', context: {
      ...
      WasteAppLogger.severe('Memory management service initialization failed',
          error: e,
          context: {
            'service': 'memory_management',
          });
  ...
  void registerDisposableResource(DisposableResource resource) {
    ...
    MemoryLeakDetector.track(
        resource, resource.resourceId, resource.resourceType);

    WasteAppLogger.debug('Disposable resource registered', context: {
      'service': 'memory_management',
  ...
  void trackImageOperation(String operationId) {
    ...
    WasteAppLogger.debug('Image operation tracked', context: {
      'service': 'memory_management',
  ...
  Future<void> forceGarbageCollection() async {
    try {
      ...
      WasteAppLogger.info('Forced garbage collection completed', context: {
        'service': 'memory_management',
        'memory_usage_mb': stats.usedMemoryMB,
        'memory_utilization': '${stats.utilizationPercent.toStringAsFixed(1)}%',
      });
    } catch (e) {
      WasteAppLogger.warning('Force garbage collection failed',
          error: e,
          context: {
            'service': 'memory_management',
          });
  ...
  Future<MemoryStats> getCurrentMemoryStats() async {
    try {
      ...
      if (!kIsWeb) {
        ...
        if (kDebugMode) {
          developer
              .log('Memory usage monitoring is only available in debug mode');
        }
      ...
      WasteAppLogger.warning('Failed to get memory stats', error: e, context: {
        'service': 'memory_management',
      });
  ...
  Future<Map<String, dynamic>> checkMemoryLeaks() async {
    ...
    if (leaks.isNotEmpty) {
      WasteAppLogger.warning('Potential memory leaks detected', context: {
        'service': 'memory_management',
  ...
  Future<void> dispose() async {
    ...
    try {
      ...
      WasteAppLogger.info('Memory management service disposed', context: {
        'service': 'memory_management',
        'resources_cleaned': resourceIds.length,
        'operations_cleaned': operationIds.length,
      });
    } catch (e) {
      WasteAppLogger.severe('Error during memory management service disposal',
          error: e,
          context: {
            'service': 'memory_management',
          });
  ...
  Future<void> _performMemoryCheck() async {
    ...
    try {
      ...
      if (stats.utilizationPercent > _memoryCriticalThreshold) {
        WasteAppLogger.warning('Critical memory usage detected', context: {
          'service': 'memory_management',
        ...
        WasteAppLogger.info('High memory usage detected', context: {
          'service': 'memory_management',
          'utilization_percent': stats.utilizationPercent,
          'used_memory_mb': stats.usedMemoryMB,
        });
      ...
      if (stats.gcCount > _lastGcCount) {
        WasteAppLogger.debug('Garbage collection activity detected', context: {
          'service': 'memory_management',
      ...
      WasteAppLogger.warning('Memory check failed', error: e, context: {
        'service': 'memory_management',
      });
    }
  }
  ...
  Future<void> _performPeriodicCleanup() async {
    try {
      ...
      WasteAppLogger.debug('Periodic cleanup completed', context: {
        'service': 'memory_management',
      ...
      WasteAppLogger.warning('Periodic cleanup failed', error: e, context: {
        'service': 'memory_management',
      });
    }
  }
  ...
  void _cleanupResource(String resourceId) {
    ...
    if (resource != null) {
      try {
        ...
        WasteAppLogger.debug('Resource cleaned up', context: {
          'service': 'memory_management',
          'resource_id': resourceId,
          'resource_type': resource.resourceType,
        });
      } catch (e) {
        WasteAppLogger.warning('Error disposing resource', error: e, context: {
          'service': 'memory_management',
          'resource_id': resourceId,
          'resource_type': resource.resourceType,
        });
  ...
  void _cleanupImageOperation(String operationId) {
    ...
    WasteAppLogger.debug('Image operation cleaned up', context: {
      'service': 'memory_management',
      'operation_id': operationId,
  ...
  Future<void> _clearImageCache({bool partial = false}) async {
    try {
      if (partial) {
        ...
        WasteAppLogger.debug('Partial image cache clear requested', context: {
          'service': 'memory_management',
        });
      } else {
        // Clear entire cache
        WasteAppLogger.debug('Full image cache clear requested', context: {
          'service': 'memory_management',
        });
      }
    } catch (e) {
      WasteAppLogger.warning('Image cache clear failed', error: e, context: {
        'service': 'memory_management',
        'partial': partial,
      });
    }
