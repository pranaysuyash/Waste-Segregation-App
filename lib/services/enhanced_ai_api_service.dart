  ...
  "disposal_bin": "Blue|Green|Red|Black",
   ...
   "environmentalImpactEvidence": {
     "co2_avoidance": {
       ...
       "sources": ["WARM_v16"],
       "inputSignals": {"material": "plastic", "region": "KA"},
       "methodologyVersion": "WARM-v16",
       "geography": "IN-KA",
       "scenario": "recycle_vs_landfill",
       "decisionSupported": "household_disposal_route",
       "userExplanation": "Compared scenario-based CO2 impacts for local municipal routing",
       "confidence": 0.72
     },
   },
